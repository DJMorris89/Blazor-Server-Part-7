...
GO
PRINT N'Creating Procedure [dbo].[spPeople_ReadOne]...';
...
GO
PRINT N'Creating Procedure [dbo].[spPeople_Search]...';
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '7bcd893f-d70d-4e62-aa55-335b954b39ca')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('7bcd893f-d70d-4e62-aa55-335b954b39ca')
